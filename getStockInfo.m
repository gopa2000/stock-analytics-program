function calData = getStockInfo(stock)
    ...
    calData = struct('TradingDays', TradingDays, 'AnnualReturn', AnnualReturn, 'AvgDailyReturn', AvgDailyReturn, 'AvgAnnualisedReturn', AvgAnnualisedReturn, 'DailyVolatility', DailyVolatility, 'AnnualisedVolatility', AnnualisedVolatility, 'SharpeRatio', SharpeRatio);
end